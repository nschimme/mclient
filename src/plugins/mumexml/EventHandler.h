...
public slots:
 ...
 protected:
	...
	*/
	...
	enum XmlMode {XML_NONE, XML_PROMPT, XML_ROOM, XML_NAME, XML_DESCRIPTION, XML_TERRAIN, XML_MAGIC, XML_EXITS, XML_TELL, XML_SAY, XML_NARRATE, XML_SONG, XML_PRAY, XML_SHOUT, XML_YELL, XML_EMOTE, XML_HIT, XML_DAMAGE, XML_WEATHER, XML_VIEW, XML_VIEW_TITLE, XML_VIEW_BODY, XML_EDIT, XML_EDIT_TITLE, XML_EDIT_BODY};
	XmlMode _xmlMode;
